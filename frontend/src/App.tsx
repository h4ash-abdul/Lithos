...
export function App() {
  ...
  // Dedicated Starting Page Experience (Lithos Hero)
  if (activeTab === "overview") {
    return (
      <div className="min-h-screen bg-[#000000] text-[#e8e6df] antialiased font-sans">
        <LithosHero
  ...
  return (
    <div className="portal-workspace min-h-screen bg-[#050806] text-[#e8e6df] flex flex-col antialiased relative overflow-x-hidden">
